...
When a customer tweets positively about a company, it bodes well for their future brand loyalty and perhaps that of their followers and friends. While this may be reflected in future quarterly sales numbers, I was interested to see if the stock market was in any way accounting for real time customer feedback in valuing the company. Working with such a short window (limited to a 3 week subset of the data), I was really only interested in identifying whether this avenue justified further research (ex. I didn't control for overall market movements). The graphic below shows daily sentiment scores (top), daily change in stock price (middle), daily volume of trades (bottom). 
