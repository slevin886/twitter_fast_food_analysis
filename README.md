...
The graphic below shows the average daily tweet volume by company. In contrast to the large differences in daily sentiment across companies, there is higher covariance in tweet volume. However, it can't be ruled out that this isn't at least somewhat biased by the artificial limits Twitter put on the number of Tweets I could scrape. 
